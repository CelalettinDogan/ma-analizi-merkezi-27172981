    ...
    <div className="h-screen overflow-hidden bg-gradient-to-b from-background via-background to-muted/30 flex flex-col pt-safe">
      ...
      <div className="flex-1 overflow-hidden px-7 pb-2 max-w-md mx-auto w-full">
        ...
        <div className="flex items-center gap-3 my-4">
          ...
          <span className="text-[11px] text-muted-foreground/50 uppercase tracking-wider">veya</span>
          <div className="flex-1 h-px bg-border/50" />
        </div>
        ...
        <motion.div whileTap={{ scale: 0.97 }}>
          <Button
            type="button"
            variant="outline"
            className="w-full h-[52px] rounded-2xl text-[15px] font-medium border-border/50 bg-muted/10"
          ...
          >
            {isGoogleLoading ? (
              <><Loader2 className="h-4 w-4 mr-2 animate-spin" />Bağlanıyor...</>
            ) : (
              <>
