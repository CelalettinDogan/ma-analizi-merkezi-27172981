...
const HeroSection: React.FC<HeroSectionProps> = ({ 
  ...
  return (
    <section className="relative px-4 pt-2 pb-1">
      {stats.totalPredictions > 0 ? (
        <motion.div
          initial={{ opacity: 0, y: 6 }}
          animate={{ opacity: 1, y: 0 }}
          className="rounded-2xl bg-gradient-to-br from-primary/8 via-primary/4 to-transparent border border-primary/10 px-3.5 py-3"
        >
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              {stats.liveCount > 0 && (
                <Link to="/live" className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-destructive/10 border border-destructive/15">
