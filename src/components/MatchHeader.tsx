    ...
    <div className="glass-card p-6 md:p-8 mb-8 animate-fade-in">
      ...
      <div className="flex items-center justify-center gap-4 md:gap-8">
        <div className="flex-1 text-center">
          ...
          <span className="text-sm text-muted-foreground">{t('forms.homeTeam')}</span>
        </div>

        <div className="flex flex-col items-center">
          <div className="text-3xl md:text-5xl font-display font-bold gradient-text-gold">{t('forms.vs')}</div>
        </div>
        ...
        <div className="flex-1 text-center">
          ...
          <span className="text-sm text-muted-foreground">{t('forms.awayTeam')}</span>
        </div>
      </div>
    </div>
  );
